      ...
      <div class="container mx-auto px-4 py-12">
        ...
        <div class="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div class="flex gap-4">
            @if (instagramUrl()) {
              <a [href]="instagramUrl()" target="_blank" rel="noopener" class="hover:text-accent transition-colors">
            ...
            @if (twitterUrl()) {
              <a [href]="twitterUrl()" target="_blank" rel="noopener" class="hover:text-accent transition-colors">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
